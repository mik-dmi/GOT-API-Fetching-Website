...
const Hero = () =>  (
    <section id="home" className={`flex sm:flex-row flex-col sm:justify-center justify-start sm:items-start items-center sm:mt-[7rem] mt-[5rem]`}> 
        <div className='flex flex-col sm:items-start items-center'>
            ...
            <p className={`${styles.paragraph} sm:max-w-[25rem] max-w-[20rem] sm:text-left text-center text-shadow-md`}>Explore Houses and Characters in the Game of Thrones Universe using the search bars</p>
